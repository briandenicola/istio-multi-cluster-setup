...
export CENTRAL_VNET_NAME=$(terraform -chdir=./infrastructure output -raw VNET_RESOURCE_ID)
export CENTRAL_VNET_ID=$(terraform -chdir=./infrastructure output -raw VNET_NAME)
...
export SOUTH_CENTRAL_VNET_NAME=$(terraform -chdir=./infrastructure output -raw VNET_RESOURCE_ID)
export SOUTH_CENTRAL_VNET_ID=$(terraform -chdir=./infrastructure output -raw VNET_NAME)